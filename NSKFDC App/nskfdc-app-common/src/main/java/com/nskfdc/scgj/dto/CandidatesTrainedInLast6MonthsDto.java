...
public class CandidatesTrainedInLast6MonthsDto extends BaseDto{
	...
	public CandidatesTrainedInLast6MonthsDto() {
		super();
	...
	public CandidatesTrainedInLast6MonthsDto(String month, int count) {
		super();

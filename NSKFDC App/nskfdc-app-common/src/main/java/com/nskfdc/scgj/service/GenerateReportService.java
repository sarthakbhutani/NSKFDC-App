...
public class GenerateReportService {
	...
	public int generateOccupationCertificateReport(String batchId) {
		...
		LOGGER.debug("In Generate Occupation Certificate Service");
			...
			try {	
				...
				Collection<GenerateOccupationCertificateReportDto> occupationReportDetails = generateReportDao.generateOccupationCertificateReport(batchId);
    ...
    public int generateAttendanceSheet(String batchId) {
		
			try {
				
				LOGGER.debug("In try block of Generate Attendance Sheet Service");
				Collection<GenerateAttendanceSheetDto> attendanceSheetDetails = generateReportDao.generateAttendanceSheet(batchId);
